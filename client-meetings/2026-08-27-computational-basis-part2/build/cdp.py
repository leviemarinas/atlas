...
def _find_chrome():
    """Locate a Chrome/Edge binary: $CHROME first, then the usual install paths."""
    ...
    for path in candidates:
        if path and os.path.exists(path):
            return path
    raise RuntimeError("No Chrome or Edge binary found. Set the CHROME environment variable.")
