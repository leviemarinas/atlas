...
export const managementScreens = Object.freeze([
  ...
  { key: 'staggered-payment-approval', group: 'employee-requests-management', column: 'Approvals', kind: 'request', application: 'staggered-payment', title: 'Staggered Payment Request Approval', cardLabel: 'Staggered Payment Request Approval', icon: 'cash' },
  { key: 'staggered-payment-management', group: 'employee-requests-management', column: 'Management', kind: 'request', application: 'staggered-payment', title: 'Staggered Payment Request Management', cardLabel: 'Staggered Payment Request Management', icon: 'cash' },
