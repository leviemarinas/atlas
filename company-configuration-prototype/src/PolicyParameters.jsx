...
const templates = {
  ...
  'Take-Home Pay': [
    ...
    parameter('employeeGroup', 'Employee group', 'select', 'All Employees', { options: ['All Employees', 'Rank and File', 'Managers', 'Project-based Employees'] }),
  ...
  'Final Pay': [
    ...
    parameter('includeSeparationPay', 'Include separation pay', 'boolean', 'No'),
    ...
    parameter('includeAllowances', 'Include allowances', 'boolean', 'Yes'),
    parameter('includeCommissions', 'Include commissions', 'boolean', 'No'),
    ...
    parameter('leaveConversionRule', 'Leave conversion rule', 'select', 'Convert unused VL and SIL at the current daily rate', { options: ['Convert unused VL and SIL at the current daily rate', 'Convert SIL only', 'Do not convert leave'] }),
    parameter('separationPayRule', 'Separation pay rule', 'select', 'Not applicable - retirement', { options: ['Not applicable - retirement', 'Apply statutory separation pay', 'Apply company separation plan'] }),
    parameter('dailyRateDivisor', 'Daily-rate divisor', 'number', '30', { unit: 'days' }),
    parameter('serviceRounding', 'Service rounding', 'select', 'Six months or more counts as one year', { options: ['Six months or more counts as one year', 'Exact completed years', 'Round down to completed years'] }),
  ...
  'Deferred Deductions': [parameter('carryForward', 'Carry forward balance', 'boolean', 'Yes'), parameter('rescheduleRule', 'Reschedule rule', 'select', 'Next Payroll', { options: ['Next Payroll', 'Next Month', 'Manual Review'] }), parameter('notifyEmployee', 'Notify employee', 'boolean', 'Yes')],
...
export const codeParameterScopes = {
  ...
  'FIN-001': { governs: 'Final pay components and offsets' },
