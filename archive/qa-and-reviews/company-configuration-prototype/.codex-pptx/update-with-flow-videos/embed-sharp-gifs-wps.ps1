...
$finalDeck = 'C:\Users\josrp\OneDrive\Documents\Atlas\ATLAS_Phase2_Computational_Basis_Demo_WPS_Sharp_Embedded_GIFs.pptx'
$mediaDir = Join-Path $PSScriptRoot 'media-sharp'
